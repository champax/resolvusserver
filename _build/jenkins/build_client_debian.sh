...
rm -f /var/lib/jenkins/workspace/resolvusserver_*
rm -f /var/lib/jenkins/workspace/resolvusserver-*
rm -rf /var/lib/jenkins/workspace/resolvusserver@tmp
...
dpkg-buildpackage --build=full --sign-key=TODO -rfakeroot
...
echo "LISTING NOW"
ls -l /var/lib/jenkins/workspace/resolvusserver_*
